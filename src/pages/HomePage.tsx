...
const checklist = [
  'Pick the hero and supporting sections you need',
  'Swap copy, logos, and metrics for your audience',
  'Preview in Vite and ship with confidence',
]
  ...
  return (
    <main className="app">
      <section className="hero">
        <p className="eyebrow">Issue #17 · Smart dev hub</p>
        ...
        <p className="cat-story">
          Nimbus the studio cat naps beside the monitors and keeps watch with a quiet purr, reminding the team to ship with
          calm, curious energy.
        </p>
